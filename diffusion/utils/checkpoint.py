...
def save_checkpoint(work_dir,
    ...
    if byt5_encoder is not None:
        state_dict['byt5_encoder'] = byt5_encoder.state_dict()
    if byt5_mapper is not None:
        state_dict['byt5_mapper'] = byt5_mapper.state_dict()
...
def load_checkpoint(checkpoint,
    ...
    state_dict_keys = ['pos_embed', 'base_model.pos_embed', 'model.pos_embed','model.y_embedder.y_embedding']
    ...
    if byt5_encoder is not None:
        byt5_encoder.load_state_dict(checkpoint['byt5_encoder'])
    if byt5_mapper is not None:
        byt5_mapper.load_state_dict(checkpoint['byt5_mapper'])
